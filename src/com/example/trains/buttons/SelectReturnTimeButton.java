...
public class SelectReturnTimeButton extends EditedButton {
	
	public SelectReturnTimeButton(Context context) {
		super(context);
		setUpTouch();
	}
	
	public SelectReturnTimeButton (Context context, AttributeSet attrs) {
		super(context, attrs);
		setUpTouch();
	}

	public SelectReturnTimeButton (Context context, AttributeSet attrs, int defStyle) {
	...
	public void setUpTouch() {
		...
		final SelectReturnTimeButton thisButton = this;
		this.setOnTouchListener(new OnTouchListener() {
			@TargetApi(Build.VERSION_CODES.JELLY_BEAN)
				...
				public boolean onTouch(View arg0, MotionEvent event) {
			    	...
			    	activity.getUserToEnterReturnTime(thisButton);
			    }
