...
public class SelectTimeButton extends EditedButton {
	
	public SelectTimeButton(Context context) {
		super(context);
		setUpTouch();
	}
	
	public SelectTimeButton (Context context, AttributeSet attrs) {
		super(context, attrs);
		setUpTouch();
	}

	public SelectTimeButton (Context context, AttributeSet attrs, int defStyle) {
	...
	public void setUpTouch() {
		...
		final SelectTimeButton thisButton = this;
		this.setOnTouchListener(new OnTouchListener() {
			@TargetApi(Build.VERSION_CODES.JELLY_BEAN)
				...
				public boolean onTouch(View arg0, MotionEvent event) {
			    	...
			    	activity.getUserToEnterStartDate(thisButton);
			    }
