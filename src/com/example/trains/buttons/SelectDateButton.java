...
public class SelectDateButton extends EditedButton {
	...
	public SelectDateButton (Context context, AttributeSet attrs) {
		super(context, attrs);
		setUpTouch();
	}

	public SelectDateButton (Context context, AttributeSet attrs, int defStyle) {
	...
	public void setUpTouch() {
		...
		final SelectDateButton thisButton = this;
